...
<head>
    ...
    <title>{{ config('app.name', 'The Trippytrip') }}</title>
    ...
    <link href="{{ url('public/plugins/owlcarousel/css/owl.carousel.min.css') }}" rel="stylesheet" >
<link href="{{url('public/plugins/owlcarousel/css/owl.theme.default.css')}}" rel="stylesheet">
<link href="{{url('public/plugins/owlcarousel/css/owl.carousel.css')}}" rel="stylesheet">
...
<!--script carousel-->
<script type="text/javascript" src="{{url('public/plugins/owlcarousel/js/jquery.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/plugins/owlcarousel/js/tether.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/plugins/owlcarousel/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/plugins/owlcarousel/js/owl.carousel.min.js')}}"></script>
